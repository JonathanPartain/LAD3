...
public class TramNetwork{
     ...
     * @param stationName The (partial) name of the station.
     * @return The first station after stationName in alphabetical order.
     * */
    ...
    public class Tram{
        ...
        /**
         * The time in minutes you will have to wait at station 
